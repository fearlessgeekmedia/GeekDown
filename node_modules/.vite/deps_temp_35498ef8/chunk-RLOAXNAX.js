...
var codeBlockConfig = $ctx(defaultConfig, "codeBlockConfigCtx");
...
var codeComponent = ({
  ...
  const preview = useMemo(() => {
    var _a2;
    const preview2 = (_a2 = config == null ? void 0 : config.renderPreview) == null ? void 0 : _a2.call(config, language != null ? language : "", text != null ? text : "");
    return preview2;
  }, [language, text]);
  useEffect(() => {
  ...
  return html`<host class=${clsx_default(selected && "selected")}>
    <div class="tools">
      ...
      <div
        ref=${pickerRef}
        data-expanded=${showPicker}
        class=${clsx_default("language-picker", showPicker && "show")}
      >
        <div class="list-wrapper">
          <div class="search-box">
            ...
            />
            <div
              class=${clsx_default("clear-icon", filter.length === 0 && "hidden")}
              onmousedown=${onClear}
            >
      ...
      <button
        class=${clsx_default("preview-toggle-button", !preview && "hidden")}
        onclick=${() => setPreviewOnlyMode(!previewOnlyMode)}
      >
        ${(_d = config == null ? void 0 : config.previewToggleButton) == null ? void 0 : _d.call(config, previewOnlyMode)}
      </button>
    </div>
    <div
      class=${clsx_default("codemirror-host", preview && previewOnlyMode && "hidden")}
    >
      ${h(codemirror == null ? void 0 : codemirror.dom, {})}
    </div>
    <div class=${clsx_default("preview-panel", !preview && "hidden")}>
      <div class=${clsx_default("preview-divider", previewOnlyMode && "hidden")}></div>
      <div class=${clsx_default("preview-label", previewOnlyMode && "hidden")}>
        ${(_e = config == null ? void 0 : config.previewLabel) == null ? void 0 : _e.call(config)}
      </div>
...
//# sourceMappingURL=chunk-RLOAXNAX.js.map
