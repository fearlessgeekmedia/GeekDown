...
import "./chunk-SFBFV7Z3.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-MSJO52CE.js";
import {
  IndentContext,
  NodeProp,
  bracketMatching,
...
// ../node_modules/@milkdown/crepe/lib/esm/index-B3KiKTSt.js
var visibilityOffIcon = html`
  <svg
...
var defineFeature = (editor, config = {}) => {
  editor.config(async (ctx) => {
    ...
    if (!languages) {
      const { languages: langList } = await import("./dist-OH6AX3VU.js");
      languages = langList;
    }
    if (!theme) {
      const { oneDark } = await import("./dist-B2EN7CBT.js");
      theme = oneDark;
    }
...
//# sourceMappingURL=index-B3KiKTSt-J2VQHDA7.js.map
