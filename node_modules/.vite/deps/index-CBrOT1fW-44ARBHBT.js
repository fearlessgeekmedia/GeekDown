...
// ../node_modules/@milkdown/components/lib/table-block/index.es.js
...
function createDragOverHandler(refs) {
  return (0, import_lodash.default)((e) => {
    const context = prepareDndContext(refs);
    if (!context)
      return;
...
var tableComponent = ({
  ...
  return html`
    <host
      class=${clsx_default(!(view == null ? void 0 : view.editable) && "readonly")}
...
var TableElement = c(tableComponent);
var __typeError = (msg) => {
  throw TypeError(msg);
};
...
handleClick_fn = function(event) {
  ...
  if (state.selection instanceof TextSelection) {
    ...
    if ((currentNode == null ? void 0 : currentNode.node) === node.node)
      return false;
  }
  const { from } = node;
...
var tableBlock = [tableBlockConfig, tableBlockView];

// ../node_modules/@milkdown/crepe/lib/esm/index-CBrOT1fW.js
...
//# sourceMappingURL=index-CBrOT1fW-44ARBHBT.js.map
