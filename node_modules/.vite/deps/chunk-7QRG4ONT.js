...
var linkTooltipState = $ctx(__spreadValues$2({}, defaultState), "linkTooltipStateCtx");
...
var linkTooltipAPI = $ctx(__spreadValues$2({}, defaultAPI), "linkTooltipAPICtx");
withMeta(linkTooltipState, {
...
var linkPreviewTooltip = tooltipFactory("LINK_PREVIEW");
...
var linkEditTooltip = tooltipFactory("LINK_EDIT");
...
function configureLinkPreviewTooltip(ctx) {
  ...
  const DELAY = 200;
  const onMouseMove = (0, import_lodash.default)((view, event) => {
  ...
  return html`
    <host>
      <div class="link-edit">
        ...
        />
        <span
          class=${clsx_default("button confirm", !link && "hidden")}
...
//# sourceMappingURL=chunk-7QRG4ONT.js.map
