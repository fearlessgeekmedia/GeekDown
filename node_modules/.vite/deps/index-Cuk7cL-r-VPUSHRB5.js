...
// ../node_modules/@milkdown/crepe/lib/esm/index-Cuk7cL-r.js
function configureListItem(ctx, config) {
  ctx.set(listItemBlockConfig.key, {
    renderLabel: ({ label, listType, checked, readonly }) => {
      ...
      if (checked)
        return html`<span
          class=${clsx_default("label checkbox", readonly && "readonly")}
          >${(_d = (_c = config == null ? void 0 : config.checkBoxCheckedIcon) == null ? void 0 : _c.call(config)) != null ? _d : checkBoxCheckedIcon}</span
        >`;
      return html`<span class=${clsx_default("label checkbox", readonly && "readonly")}
...
//# sourceMappingURL=index-Cuk7cL-r-VPUSHRB5.js.map
