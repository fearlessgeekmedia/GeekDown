  ...
  */
  replace(tr, content3 = Slice.empty) {
    ...
    for (let i = 0; i < ranges.length; i++) {
      ...
      tr.replaceRange(mapping.map($from.pos), mapping.map($to.pos), i ? Slice.empty : content3);
      if (i == 0)
...
var mac3 = ios2 || (nav2 ? /Mac/.test(nav2.platform) : false);
...
function captureKeyDown(view, event) {
  ...
  if (code2 == 8 || mac3 && code2 == 72 && mods == "c") {
    return stopNativeHorizontalDelete(view, -1) || skipIgnoredNodes(view, -1);
  } else if (code2 == 46 && !event.shiftKey || mac3 && code2 == 68 && mods == "c") {
    return stopNativeHorizontalDelete(view, 1) || skipIgnoredNodes(view, 1);
  } else if (code2 == 13 || code2 == 27) {
    return true;
  } else if (code2 == 37 || mac3 && code2 == 66 && mods == "c") {
    let dir = code2 == 37 ? findDirection(view, view.state.selection.from) == "ltr" ? -1 : 1 : -1;
    return selectHorizontally(view, dir, mods) || skipIgnoredNodes(view, dir);
  } else if (code2 == 39 || mac3 && code2 == 70 && mods == "c") {
    let dir = code2 == 39 ? findDirection(view, view.state.selection.from) == "ltr" ? 1 : -1 : 1;
    return selectHorizontally(view, dir, mods) || skipIgnoredNodes(view, dir);
  } else if (code2 == 38 || mac3 && code2 == 80 && mods == "c") {
    return selectVertically(view, -1, mods) || skipIgnoredNodes(view, -1);
  } else if (code2 == 40 || mac3 && code2 == 78 && mods == "c") {
    return safariDownArrowBug(view) || selectVertically(view, 1, mods) || skipIgnoredNodes(view, 1);
  } else if (mods == (mac3 ? "m" : "c") && (code2 == 66 || code2 == 73 || code2 == 89 || code2 == 90)) {
    return true;
  }
  return false;
}
...
var DOMObserver = class {
  constructor(view, handleDOMChange) {
    ...
    this.observer = window.MutationObserver && new window.MutationObserver((mutations) => {
      ...
      if (ie2 && ie_version2 <= 11 && mutations.some((m) => m.type == "childList" && m.removedNodes.length || m.type == "characterData" && m.oldValue.length > m.target.nodeValue.length))
        this.flushSoon();
      else
        this.flush();
    });
...
function readDOMChange(view, from, to, typeOver, addedNodes) {
  ...
  if (parse2.sel) {
    ...
    if (sel2 && !(chrome2 && view.composing && sel2.empty && (change.start != change.endB || view.input.lastChromeDelete < Date.now() - 100) && (sel2.head == chFrom || sel2.head == tr.mapping.map(chTo) - 1) || ie2 && sel2.empty && sel2.head == chFrom))
...
var SliceType = class {
  ...
  create(container, value = this._defaultValue) {
    return new Slice2(container, value, this);
  }
};
...
var _Ctx = class _Ctx2 {
  ...
  constructor(container, clock, meta) {
    ...
    if (meta)
      __privateSet(this, _inspector, new Inspector(container, clock, meta));
  }
  ...
  constructor(clock, type) {
    ...
    this.start = () => {
      __privateGet(this, _promise) ?? __privateSet(this, _promise, new Promise((resolve, reject) => {
        ...
        __privateGet(this, _waitTimeout).call(this, () => {
          if (__privateGet(this, _status) === "pending")
            __privateSet(this, _status, "rejected");
          __privateGet(this, _removeListener).call(this);
    ...
    __privateSet(this, _removeListener, () => {
      if (__privateGet(this, _listener))
        removeEventListener(this.type.name, __privateGet(this, _listener));
    });
...
function initializeDocument(effects) {
  ...
  function documentContinue(code2) {
    ...
    if (self.containerState._closeFlow) {
      ...
      ok2(point3, "could not find previous flow chunk");
...
function resolveToSetextUnderline(events, context) {
  ...
  ok2(text4 !== void 0, "expected a `text` index to be found");
...
var _ParserState = class _ParserState2 extends Stack {
  ...
  constructor(schema2) {
    ...
    __privateSet2(this, _addNodeAndPush, (nodeType, attrs, content3) => {
      ...
      if (!node2)
        throw createNodeInParserFail(nodeType, attrs, content3);
      this.push(node2);
      return node2;
    });
...
var _SerializerState = class _SerializerState2 extends Stack {
  ...
  constructor(schema2) {
    ...
    __privateSet2(this, _matchTarget2, (node2) => {
      ...
      if (!result)
        throw serializerMatchError(node2.type);
      return result;
    });
    ...
    __privateSet2(this, _runNode2, (node2) => {
      ...
      if (unPreventNext)
        __privateGet2(this, _runProseNode).call(this, node2);
    ...
    __privateSet2(this, _searchType, (child, type) => {
      ...
      if (child.type === type)
        return child;
      if (((_a = child.children) == null ? void 0 : _a.length) !== 1)
        return child;
      const searchNode = (node22) => {
        var _a2;
        if (node22.type === type)
          return node22;
        if (((_a2 = node22.children) == null ? void 0 : _a2.length) !== 1)
          return null;
    ...
    __privateSet2(this, _createMarkdownNode, (element2) => {
      ...
      if (element2.children)
        node2.children = element2.children;
      if (element2.value)
        node2.value = element2.value;
      return node2;
    });
    ...
    __privateSet2(this, _moveSpaces, (element2, onPush) => {
      ...
      if (startSpaces.length)
        __privateGet2(this, _addNodeAndPush2).call(this, "text", void 0, startSpaces);
      const result = onPush();
      if (endSpaces.length)
        __privateGet2(this, _addNodeAndPush2).call(this, "text", void 0, endSpaces);
      return result;
    });
    __privateSet2(this, _closeNodeAndPush2, (trim = false) => {
      ...
      if (trim)
        return __privateGet2(this, _moveSpaces).call(this, element2, onPush);
      return onPush();
    });
    this.closeNode = () => {
...
var CommandManager = class {
  ...
  call(slice, payload) {
    if (__privateGet3(this, _ctx) == null)
    ...
    __privateSet3(this, _cleanup, (plugins, remove = false) => {
      return Promise.all(
        [plugins].flat().map((plugin) => {
          ...
          if (remove)
            __privateGet3(this, _usrPluginStore).delete(plugin);
          else
...
function $useKeymap(name, userKeymap) {
  const key2 = Object.fromEntries(
    Object.entries(userKeymap).map(([key22, { shortcuts: shortcuts2 }]) => {
      return [key22, shortcuts2];
    })
  );
  ...
  const shortcuts = $shortcut((ctx) => {
    ...
    const keymapTuple = Object.entries(userKeymap).flatMap(
      ([key22, { command }]) => {
        const targetKeys = [keys2[key22]].flat();
...
//# sourceMappingURL=chunk-SFBFV7Z3.js.map
